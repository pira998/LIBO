    ...
    -->
            ...
            <div class="sidebar-wrapper">
                <ul class="nav">
                    ...
                    <li class="nav-item ">
                        <a class="nav-link" href="../views/borrowed_books.php">
                            <i class="material-icons">library_books</i>
                            <p>Borrowed book</p>
                        </a>
                    </li>
                    <li class="nav-item ">
                        <a class="nav-link" href="../views/requested_books.php">
                            <i class="material-icons">library_books</i>
                            <p>Requested books</p>
                        </a>
                    </li>
                        ...
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownProfile">
                                    ...
                                    <a class="dropdown-item" href="/student/views/dashboard.php?logout=1">Log out</a>
                                </div>
                            </li>
                        </ul>
                    </div>
